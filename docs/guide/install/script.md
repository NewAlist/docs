...
```bash
# Install
curl -fsSL "https://doc.newalist.top/v3-en.sh" -o v3-en.sh && bash v3-en.sh install /root
# update
curl -fsSL "https://doc.newalist.top/v3-en.sh" -o v3-en.sh && bash v3-en.sh update /root
# Uninstall
curl -fsSL "https://doc.newalist.top/v3-en.sh" -o v3-en.sh && bash v3-en.sh uninstall /root
```
