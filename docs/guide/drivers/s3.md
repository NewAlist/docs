...
Finally, remember to enable **`Force Path Style`** to use, otherwise it cannot be used [Click to view details](https://github.com/NewAlist/alist/discussions/4920#discussioncomment-6635452)
