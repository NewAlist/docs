...
:::tip
**`地址树-UrlTree`** 是什么?  是用来挂载单个文件链接的，详情可以查看  **→→→[原需求说明](https://github.com/NewAlist/alist/issues/3268)←←←**
:::
...
新名称2.md:2048:https://raw.githubusercontent.com/NewAlist/alist/main/README_cn.md
```
