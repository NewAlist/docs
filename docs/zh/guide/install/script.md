...
**安装**
```bash
curl -fsSL "https://doc.newalist.top/v3.sh" -o v3.sh && bash v3.sh
```
...
**安装**
```bash
curl -fsSL "https://doc.newalist.top/beta.sh" | bash -s install
```

**更新**
```bash
curl -fsSL "https://doc.newalist.top/beta.sh" | bash -s update
```

**卸载**
```bash
curl -fsSL "https://doc.newalist.top/beta.sh" | bash -s uninstall
```
...
```bash
# Install
curl -fsSL "https://doc.newalist.top/v3.sh" -o v3.sh && bash v3.sh install /root
# update
curl -fsSL "https://doc.newalist.top/v3.sh" -o v3.sh && bash v3.sh update /root
# Uninstall
curl -fsSL "https://doc.newalist.top/v3.sh" -o v3.sh && bash v3.sh uninstall /root
```

@tab 测试版
```bash
# Install
curl -fsSL "https://doc.newalist.top/beta.sh" | bash -s install /root
# update
curl -fsSL "https://doc.newalist.top/beta.sh" | bash -s update /root
# Uninstall
curl -fsSL "https://doc.newalist.top/beta.sh" | bash -s uninstall /root
```
