...
const raw = [
  {
    ...
    url: `https://github.com/NewAlist/desktop-release/releases/latest/download/alist-desktop_${version}_aarch64.dmg`,
  },
  {
    key: "mac_x64",
    label: "MacOS (Intel)",
    url: `https://github.com/NewAlist/desktop-release/releases/latest/download/alist-desktop_${version}_x64.dmg`,
  },
  {
    key: "win_x64",
    label: "Windows (X64)",
    url: `https://github.com/NewAlist/desktop-release/releases/latest/download/alist-desktop_${version}_x64_en-US.msi`,
  },
  {
    key: "win_arm64",
    label: "Windows (ARM64)",
    url: `https://github.com/NewAlist/desktop-release/releases/latest/download/alist-desktop_${version}_arm64-setup.exe`,
  },
  {
    key: "linux",
    label: "Linux",
    url: `https://github.com/NewAlist/desktop-release/releases/latest/download/alist-desktop_${version}_amd64.deb`,
  },
] as const
